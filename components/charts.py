...
[data-testid="metric-container"] { background:#FFFFFF; border:1px solid #E5E5E5; border-radius:10px; padding:20px 24px; box-shadow:0 1px 2px rgba(0,0,0,0.05); transition:box-shadow 0.2s; }
[data-testid="metric-container"]:hover { box-shadow:0 2px 8px rgba(0,0,0,0.08); }
[data-testid="metric-container"] label { font-size:11px !important; font-weight:600 !important; letter-spacing:0.06em !important; text-transform:uppercase !important; color:#666666 !important; }
[data-testid="metric-container"] [data-testid="stMetricValue"] { font-size:28px !important; font-weight:700 !important; color:#1A1A1A !important; }
...
.stButton > button { background:#FFFFFF; color:#1A1A1A; border:1px solid #E5E5E5; border-radius:6px; font-family:Inter,sans-serif; font-size:13px; font-weight:500; padding:6px 16px; transition:all 0.15s; }
.stButton > button:hover { background:#F7F7F7; border-color:#D0D0D0; box-shadow:0 1px 2px rgba(0,0,0,0.05); }
.stButton > button[kind="primary"] { background:#2563EB; color:#FFFFFF; border-color:#2563EB; }
...
.stTabs [data-baseweb="tab"] { font-family:Inter,sans-serif; font-size:13px; font-weight:500; color:#666666; padding:8px 16px; border-radius:0; border-bottom:2px solid transparent; }
